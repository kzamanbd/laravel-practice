<template>
    <div class="page__404 wrapper">
        <svg class="svg-animation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
            <title>404</title>
        ...
        <div class="message-box">
            <p>
                Oops! The page you are looking for might have been removed, had its name changed, or
                is temporarily unavailable.
            </p>
            <div class="buttons-con">
                <div class="action-link-wrap">
                    <a onclick="history.back(-1)" class="link-button link-back-button">Go Back</a>
                    <a href="/messaging" class="link-button">Go to Home Page</a>
                </div>
            </div>
        </div>
    </div>
