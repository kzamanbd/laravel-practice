                                ...
                                <div class="flex flex-col lg:flex-row mx-auto bg-white dark:bg-gray-800 rounded shadow">
                                    <div class="w-full lg:w-1/2 px-6 flex flex-col items-center py-5">
                                        <div class="w-24 h-24 mb-3 p-2 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                                            <img role="img" class="w-full h-full overflow-hidden object-cover rounded-full" src="https://ui-avatars.com/api/?name={{ $user->name }}&color=7F9CF5&background=EBF4FF" alt="avatar" />
                                        </div>
                                        ...
                                        <a tabindex="0" class="flex items-center cursor-pointer hover:text-indigo-700 focus:underline focus:outline-none focus:text-indigo-700 flex text-gray-600 dark:text-gray-100 text-sm tracking-normal font-normal mb-3 text-center">
                                    ...
                                    <div class="w-full lg:w-1/2 px-6 border-t-0 border-b-0 lg:border-t-0 lg:border-b-0 lg:border-l lg:border-r-0 border-gray-300 flex flex-col items-center py-5">
                                        ...
                                        <a tabindex="0" class="cursor-pointer focus:opacity-75 focus:underline hover:opacity-75 focus:outline-none text-gray-800 dark:text-gray-100 text-xl tracking-normal text-center font-medium mb-1">
                                            Account Info
                                        </a>
                                        <p class="text-gray-600 dark:text-gray-100 text-sm tracking-normal font-normal mb-8 text-center w-10/12">Account create at {{ $user->created_at }} and last updated at {{ $user->updated_at }}</p>
                                        <h1 tabindex="0" class="focus:outline-none text-lg font-bold text-gray-800 dark:text-gray-100 leading-5 pt-2">Current Roles</h1>
                                        <h2 tabindex="0" class="focus:outline-none text-sm leading-3 text-gray-600 dark:text-gray-100 my-3">{{ $user->roles->pluck('name')->join(', ') }}</h2>
                                    </div>
                                ...
                                <div>
                                    <div class="flex items-center justify-center mt-5">
                                        <div class="rounded shadow py-5 px-6 w-full bg-white dark:bg-gray-800">
                                            <h1 tabindex="0" class="text-center focus:outline-none text-lg font-bold text-gray-800 dark:text-gray-100 leading-5 pt-2 mb-2">Permissions</h1>
                                            <div class="grid grid-cols-2 gap-2">
                                                @forelse($menus_permissions as $menu => $permissions)
                                                <div class="relative rounded shadow p-5 border border-1 border-gray-300">
                                                    <p tabindex="0" class="focus:outline-none text-gray-600 dark:text-gray-100 text-sm leading-none pt-2">{{ $menu }}</p>
                                                    ...
                                                    <div class="flex items-center justify-left">
                                                        @forelse($permissions as $permission)
                                                            <div tabindex="0" class="focus:outline-none text-green-700 bg-green-100 py-1 px-2 mr-2 rounded text-xs leading-3 mt-2">
