                    ...
                    <form class="w-full" action="{{ route('user.store') }}" method="POST">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 pr-4 mb-6 md:mb-0">
                                ...
                                <input name="name" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name1" type="text" placeholder="Jane" required />
                            </div>
                                ...
                                @foreach($roles as $role)
                                    <div class="rounded bg-purple-100 border border-1 border-purple-500 p-5">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="roles[]" value="{{ $role->id }}" class="form-checkbox h-4 w-4 text-purple-600 rounded" />
