        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4">
                <form action="" method="get"
                    ...
                    <strong>Total {{ count($this->users) }} records found!</strong>
                    <input name="search" value="{{ request()->search ?? '' }}"
                        class="w-64 text-sm border rounded appearance-none p-2 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray"
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                    <div class="flex justify-between">
                        <button type="button" wire:click="create"
                            class="bg-white mb-2 text-sm text-gray-800 font-bold rounded border-b-2 border-purple-500 hover:border-purple-600 hover:bg-purple-500 hover:text-white shadow-md py-2 px-6 inline-flex items-center focus:outline-none">
                                        ...
                                        <tbody>
                                            @forelse($this->users as $user)
                                                <tr class="border-b border-gray-200 on-parent-hover-show">
                                                    ...
                                                    <td
                                                        class="text-center px-3 py-2 flex justify-center items-center on-hover-show">
                                                        <a href="{{ route('user.show', $user->id) }}"
                                                            class="bg-indigo-500 hover:bg-indigo-700 text-white rounded-full text-xs h-8 w-8 flex items-center justify-center mr-2 cursor-pointer">
                                                            <span class="material-icons text-base">visibility</span>
                                                        </a>
                                                        <button type="button" wire:click="edit({{ $user->id }})"
                                                            class="bg-purple-500 hover:bg-purple-700 text-white rounded-full text-xs h-8 w-8 flex items-center justify-center mr-2 cursor-pointer">
                                                            <span class="material-icons text-base">edit</span>
                                                        </button>

                                                        <button type="button"
                                                            wire:click="deleteUser({{ $user->id }})"
                                                            class="bg-red-500 hover:bg-red-700 text-white rounded-full text-xs h-8 w-8 flex items-center justify-center cursor-pointer">
                                                                    ...
                                                                    <g id="Group_2279" data-name="Group 2279"
                                                                        ...
                                                                        <g id="Group_2278" data-name="Group 2278"
                                                                            ...
                                                                            <rect id="Rectangle_2574"
                                                                                data-name="Rectangle 2574"
                                                                                width="11.512" height="5.616"
