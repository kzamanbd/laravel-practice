    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex justify-end space-x-4 ">
                <button class="bg-primary-100 text-primary-500 px-4 py-1.5 rounded-lg">Filter</button>
                <button class="bg-primary-500 text-white px-4 py-1.5 rounded-lg">Create</button>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="bg-white shadow-sm rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="font-semibold">
                            <h1 class="text-lg font-bold">File Manager</h1>
                            <p class="text-sm text-gray-500 space-x-2">
                                <span class="text-primary-500">Laravel</span>
                                <span>|</span>
                ...
                <div class="mt-4">
                    <nav class="p-2 flex space-x-4">
                        <a href="#" class="text-primary-500 font-semibold">Files</a>
            ...
            <div class="bg-white shadow-sm rounded-lg">
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
                    <div class="flex justify-between border-r p-4">
                        <div class="flex items-center gap-4">
                            <div class="flex size-10 items-center justify-center rounded-lg bg-[#9B51E0]/[0.08]">
                        ...
                        <div>
                            <p class="mt-1.5 font-medium text-black dark:text-white">459 MB</p>
                        </div>
                    </div>
                    <div class="flex justify-between border-r p-4">
                        <div class="flex items-center gap-4">
                            <div class="flex size-10 items-center justify-center rounded-lg bg-[#219653]/[0.08]">
                                <svg width="31" height="31" viewBox="0 0 31 31" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div>
                                <p class="text-lg font-medium text-primary-500">Image</p>
                                <span class="font-medium">
                                    12 files
                                </span>
                            </div>
                        ...
                        <div>
                            <p class="mt-1.5 font-medium text-black dark:text-white">120 MB</p>
                        </div>
                    </div>
                    <div class="flex justify-between border-r p-4">
                        <div class="flex items-center gap-4">
                            <div class="flex size-10 items-center justify-center rounded-lg bg-[#2F80ED]/[0.08]">
                                <svg width="31" height="31" viewBox="0 0 31 31" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div>
                                <p class="text-lg font-medium text-[#2F80ED]">Music</p><span class="font-medium">
                                    39 files
                                </span>
                            </div>
                        </div>
                        <div>
                            <p class="mt-1.5 font-medium text-black dark:text-white">374 MB</p>
                        </div>
                    </div>
                    <div class="flex justify-between p-4">
                        <div class="flex items-center gap-4">
                            <div class="flex size-10 items-center justify-center rounded-lg bg-[#F2994A]/[0.08]">
                                <svg width="31" height="31" viewBox="0 0 31 31" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div>
                                <p class="text-lg font-medium text-[#F2994A]">Docs</p><span class="font-medium">78
                                    files</span>
                            </div>
                        </div>
                        <div>
                            <p class="mt-1.5 font-medium text-black dark:text-white">237 MB</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg p-4">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex space-x-4">
                        <button class="flex items-center gap-2 bg-primary-100 text-primary-500 px-4 py-1.5 rounded-lg">
                        ...
                        <button class="flex items-center gap-2 bg-primary-500 text-white px-4 py-1.5 rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                fill="currentColor" class="bi bi-cloud-arrow-up" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                                    d="M7.646 5.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708z" />
                ...
                <!-- Breadcrumb -->
                <div class="text-sm flex items-center justify-between font-semibold text-gray-500 mb-4">
                    <div class="w-max py-1 px-2 rounded-lg gap-2 bg-primary-100 flex items-center">
                ...
                <!-- File List -->
                <div class="overflow-auto grid grid-cols-7 border rounded-lg">
                                            ...
                                            <svg class="size-5" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <g id="SVGRepo_iconCarrier">
                                                    ...
                                                    <path opacity="0.5"
                                                        ...
                                                        stroke="#22c55e" stroke-width="1.5"></path>
                                                    <path opacity="0.5" d="M6 16L11 16M11 16L9.125 14M11 16L9.125 18"
                                                        stroke="#22c55e" stroke-width="1.5" stroke-linecap="round"
                                                        stroke-linejoin="round"></path>
                                                </g>
                                            </svg>

                                            <span class="mx-2">index.html</span>
                                        </div>
                                    </td>
                                    <td class="py-1.5 px-3">489 KB</td>
                                    <td class="py-1.5 px-3">21 Feb 2024, 11:05 am</td>
