...
const FileManager = () => {
    return (
        <div className="py-4">
            <TabGroup className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
                    ...
                    <div>
                        ...
                        <TabList className="mt-4">
                            <nav className="p-2 flex space-x-4">
                                <Tab className="data-[selected]:text-primary-500 data-[selected]:font-semibold text-gray-500 focus-visible:outline-none">
                                    Local
                                </Tab>
                                <Tab className="data-[selected]:text-primary-500 data-[selected]:font-semibold text-gray-500 focus-visible:outline-none">
                                    Remote
